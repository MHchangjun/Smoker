...
class SmokerLauncher(private val project: Project) {

    data class Hooks(
        val log: (String) -> Unit = {},
        val onProgress: (DetektRuleProgress) -> Unit = {},
    ...
    fun start(hooks: Hooks = Hooks()): Boolean {
        ...
        val composedProgress: (DetektRuleProgress) -> Unit = { progress ->
            hooks.onProgress(progress)
            bridge.onRuleProgress(progress)
        }
